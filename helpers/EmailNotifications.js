...
class EmailNotifications {
  ...
  static async signupEmail(email, link, name) {
    ...
    const image = "";
    const title = "Welcome to Applatch";
    const body = `
                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <p>Dear User</p>
                        ...
                        Welcome to Applatch! We are excited to have you! <br/><br/>      
                          
                        <p class="message">Please verify your email and complete your account set up.</p> <br>
                            ...
                            <tr>
                              <td align="center">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                    <div><a class="link" href=${link}> <button>Verify your account</buttton></a></div>  
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">Applatch, Lagos, Nigeria</span>
                   <!--  <br> Don't like these emails? <a href="http://i.imgur.com/CScmqnj.gif">Unsubscribe</a>. -->
                  </td>
                </tr>
                <tr>
                  <td class="content-block powered-by">
                    Powered by <a href="#">Applatch</a>.
                  </td>
                </tr>
              </table>
            </div>
